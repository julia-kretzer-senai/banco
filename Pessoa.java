...
public class Pessoa {
	...
	public int num = 0;
	public int yes, confirm, numeroDaConta, agencia, digito;
	public int conta = 0;
	public String nome, endereco, prof, cpf, renda, tipoConta;
	...
	public void cadastrar() {
		...
		numeroDaConta = random.nextInt(999999999) + 100000000;
